        ...
        <form onSubmit={handleSubmit} className="contact-modal-form" noValidate>
          ...
          <div className="preference-based-fields">
            <div className="form-row">
              ...
              <div className="form-group"><label htmlFor="phone">Phone Number <span className="required">*</span></label><div className={`phone-input-wrapper ${errors.phone ? 'error' : ''}`}><PhoneInputComponent country="in" onlyCountries={['in']} disableDropdown countryCodeEditable={false} value={formData.phone} onChange={handlePhoneChange} inputProps={{ id: 'phone', name: 'phone', inputMode: 'numeric', maxLength: 12, required: true, 'aria-required': 'true', ...errorProps('phone') }} containerClass="react-phone-container" inputClass="react-phone-input-field" /></div><Error field="phone" /></div>
            </div>
